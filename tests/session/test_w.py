...
"""
    ...
    assert parsed_output['metadata'] == {'load1': '0.21', 'load2': '0.19', 'load3': '0.14',
                                         'time': '16:25:11', 'uptime': '2:35', 'users': '4'}
    assert parsed_output['records'][1] == {'command': 'vim file.txt', 'from': '192.168.1.101', 'idle': '0.00s',
                                           'jcpu': '0.05s', 'login': '14:30', 'pcpu': '0.02s', 'tty': 'pts/1',
                                           'user': 'alice'}
